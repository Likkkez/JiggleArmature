...
def get_jiggle_children(arm_matrix, pbone, lst, parent, children_of_bone):  # TODO: Move to JiggleBone as a static method?
...
def unregister():
	...
	del(bpy.types.Armature.jiggle)

	del(bpy.types.Bone.jiggle_enabled)
	del(bpy.types.Bone.jiggle_Kld)
	del(bpy.types.Bone.jiggle_Kd)
	del(bpy.types.Bone.jiggle_Ks)
	del(bpy.types.Bone.gravity_multiplier)
	del(bpy.types.Bone.jiggle_mass)
	del(bpy.types.Bone.jiggle_R)

	del(bpy.types.Bone.jiggle_W)
	del(bpy.types.Bone.jiggle_P)
	del(bpy.types.Bone.jiggle_V)

	del(bpy.types.Bone.jiggle_use_custom_rest)
	del(bpy.types.Bone.jiggle_rest)
	del(bpy.types.Bone.jiggle_control)
	del(bpy.types.Bone.jiggle_control_object)
	del(bpy.types.Bone.jiggle_control_bone)